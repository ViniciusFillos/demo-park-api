...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201() {
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Bob Marley", "43338780982"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Bob Marley");
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("43338780982");
    }
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageComStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Bob Marley", "60341191973"))
                .exchange()
    ...
    @Test
    public void criarCliente_ComCDadosInvalidos_RetornarErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Ana Beatriz", "433.387.809-82"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void buscarCliente_ComIdExistentePeloAdmin_RetornarClienteComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Beatriz Luz");
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("60341191973");
    }
    ...
    @Test
    public void buscarClientes_ComDadosDoTokenDeAdiministrador_RetornarErrorMessageComStatus403() {
        ErrorMessage  responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
