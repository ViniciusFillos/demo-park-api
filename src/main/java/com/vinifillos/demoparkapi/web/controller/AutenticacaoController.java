...
import com.vinifillos.demoparkapi.jwt.JwtUserDetailsService;
...
@Tag(name = "Autenticacao", description = "Recurso para proceder com a autenticação na API")
@RestController
...
public class AutenticacaoController {
    ...
    @Operation(summary = "Autenticar na API", description = "Recurso de autenticação na API",
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Credednciais inválidas",
